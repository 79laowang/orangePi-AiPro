...
This is a documentation and configuration repository for the Orange Pi AI Pro single-board computer. The project focuses on enabling AI/ML development on embedded hardware featuring Huawei HiSilicon Ascend 310/310B AI processors running Ubuntu 22.04.3 LTS (aarch64).
...
├── scripts/README.md           # MOTD configuration for system startup
└── qwen-code-install           # Node.js/qwen-code installation commands
```
